...
impl LanguageOption {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::LangoptionNone => "LANGOPTION_NONE",
            Self::LangoptionText => "LANGOPTION_TEXT",
            Self::LangoptionSpeech => "LANGOPTION_SPEECH",
            Self::LangoptionTextAndSpeech => "LANGOPTION_TEXT_AND_SPEECH",
        }
    }
...
impl LanguageSettingType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::LangsettingNone => "LANGSETTING_NONE",
            Self::LangsettingSingle => "LANGSETTING_SINGLE",
            Self::LangsettingSimple => "LANGSETTING_SIMPLE",
            Self::LangsettingAdvanced => "LANGSETTING_ADVANCED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ShortcutOption {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::ShortcutNone => "SHORTCUT_NONE",
            Self::ShortcutUser => "SHORTCUT_USER",
            Self::ShortcutAllUsers => "SHORTCUT_ALL_USERS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl Operation {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::OpUpdate => "OP_UPDATE",
            Self::OpBackfill => "OP_BACKFILL",
            Self::OpRepair => "OP_REPAIR",
            Self::OpNone => "OP_NONE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
